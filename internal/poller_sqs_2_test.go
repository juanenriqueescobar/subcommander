		...
		},
		{
			...
			want: func(s *SQSMock, l *logrus.Entry) *PollerSQS {
				...
				return &PollerSQS{
					...
					filters: []*PollerSQSFilter{
						{
							e: NewExec("php", []string{"testing/worker_1.php"}, l.WithFields(logrus.Fields{"sc_task.attr_name": "operation_2", "sc_task.attr_value": "task_1"})),
							f: "operation_2",
							v: "task_1",
						},
						{
							e: NewExec("php", []string{"testing/worker_2.php"}, l.WithFields(logrus.Fields{"sc_task.attr_name": "operation_2", "sc_task.attr_value": "task_2"})),
							f: "operation_2",
							v: "task_2",
						},
					},
